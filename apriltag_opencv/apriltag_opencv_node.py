...
class AprilTagDetector(Node):
    def __init__(self):
        ...
        self.tag_quaternion = np.zeros((10, 4))
    ...
    def timer_callback(self):
        ...
        for i, tag in enumerate(tags):
            ...
            self.tag_quaternion[i] = R.from_matrix(tag.pose_R).as_quat()
            ...
            transform.transform.rotation.x = self.tag_quaternion[i][0]
            transform.transform.rotation.y = self.tag_quaternion[i][1]
            transform.transform.rotation.z = self.tag_quaternion[i][2]
            transform.transform.rotation.w = self.tag_quaternion[i][3]
